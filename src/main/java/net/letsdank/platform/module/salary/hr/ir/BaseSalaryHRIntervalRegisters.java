...
public class BaseSalaryHRIntervalRegisters {
    ...
    public static void addQueryTTTransactionByIntervalRegistryName(RegistryQueriesDescriptionPacket queriesDescriptionPacket,
    ...
    public static void addQueryTTTransactionByFirstRegistry(RegistryQueriesDescriptionPacket queriesDescriptionPacket,
                                                            String registryName, boolean onlyDistrict, Object filter) {
